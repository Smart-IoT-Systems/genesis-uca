...
var engine = (function () {
	...
	return new Promise(function (resolve, reject) {
	    ...
	    if (comp.docker_resource.extra_options !== undefined
		&& comp.docker_resource.extra_options !== "") {
	...
	if (!that.dep_model.need_deployment_agent(compo)) {
		...
		if (compo._type.startsWith("/internal/thingml")) {
		    ...
		    if (compo.ansible_resource.playbook_path !== ""
			&& compo.ansible_resource.playbook_path !== undefined) {
