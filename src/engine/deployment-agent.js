    ...
    that.prepare = async function () {
        ...
        if (host_target._type === "/infra/device") {
            ...
            if (host_target.device_type.indexOf("ardui") !== -1) {
                ...
                that.flow += ',{"id": "' + id_deployer_node_in_agent + '","type": "arduino","z": "dac41de7.a03033","name": "' + that.host_target.name + '","serial": "7d118b53.12e99c","ardtype": "uno","cpu": "' + that.deployment_target.cpu + '","libraries": ' + JSON.stringify(lib_strigified) + ',"x": 590,"y": 260, "wires": [["39ea4abb.22c316"]]},';
