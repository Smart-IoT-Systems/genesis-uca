    ...
    that.prepare= async function(){
        ...
        if(host_target._type === "/infra/device"){
            ...
            if(host_target.device_type.indexOf("ardui") !== -1){
                ...
                that.flow+=',{"id": "'+id_deployer_node_in_agent+'","type": "arduino","z": "dac41de7.a03033","name": "'+that.host_target.name+'","serial": "7d118b53.12e99c","ardtype": "uno","cpu": "'+that.host_target.cpu+'","libraries": '+JSON.stringify(lib_strigified)+',"x": 590,"y": 260, "wires": [["2b6cb3a8.39dd6c"]]},{"id": "7d118b53.12e99c","type": "serial-port","z": "","serialport": "'+that.host_target.physical_port+'","serialbaud": "9600","databits": "8","parity": "none","stopbits": "1","newline": "\\n","bin": "false","out": "char","addchar": false},{"id":"2b6cb3a8.39dd6c","type":"mqtt out","z":"59bf0297.3bb18c","name":"","topic":"/deployment_agent","qos":"","retain":"","broker":"758af4ba.66f854","x":370,"y":180,"wires":[]},{"id":"758af4ba.66f854","type":"mqtt-broker","z":"","name":"GeneSIS","broker":"ws://192.168.1.28:9001","port":"9001","clientid":"","usetls":false,"compatmode":true,"keepalive":"6000","cleansession":true,"birthTopic":"","birthQos":"0","birthRetain":"false","birthPayload":"","closeTopic":"","closeQos":"0","closeRetain":"false","closePayload":"","willTopic":"","willQos":"0","willRetain":"false","willPayload":""}';
            }
