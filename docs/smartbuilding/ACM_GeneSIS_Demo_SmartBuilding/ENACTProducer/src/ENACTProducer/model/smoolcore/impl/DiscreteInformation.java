...
import ENACTProducer.model.smoolcore.IDiscreteInformation;
import ENACTProducer.model.smoolcore.ISecurity;
import ENACTProducer.model.smoolcore.impl.Security;

/**
 * This class implements the ontology concept DiscreteInformation
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class DiscreteInformation extends AbstractOntConcept implements IDiscreteInformation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "DiscreteInformation";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#DiscreteInformation"; 
  		
  		
  	/**
    * The Constructor
    */
    public DiscreteInformation() {
    	super();
        init();
	}
 	...
 	*/
	public DiscreteInformation(String id) {
	...
	*/
 	...
 	*/
	public DiscreteInformation setDataID(String dataID) {
 	...
 	*/
	public DiscreteInformation setTimestamp(String timestamp) {
 	...
 	*/
	public DiscreteInformation setSecurityData(ISecurity securityData) {
