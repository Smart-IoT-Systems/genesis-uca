...
import ENACTProducer.model.smoolcore.IDevice;
import ENACTProducer.model.smoolcore.IAlarm;
import ENACTProducer.model.smoolcore.impl.Alarm;

/**
 * This class implements the ontology concept Device
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Device extends AbstractOntConcept implements IDevice, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Device";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Device"; 
