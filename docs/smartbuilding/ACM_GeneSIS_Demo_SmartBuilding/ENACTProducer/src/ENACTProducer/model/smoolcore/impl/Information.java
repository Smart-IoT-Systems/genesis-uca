...
/**
 * This class implements the ontology concept Information
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Information extends AbstractOntConcept implements IInformation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Information";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Information"; 
	...
	*/
 	...
 	*/
	public Information setDataID(String dataID) {
 	...
 	*/
	public Information setTimestamp(String timestamp) {
 	...
 	*/
	public Information setSecurityData(ISecurity securityData) {
