...
import ENACTProducer.model.smoolcore.IRangeActuator;
...
/**
 * This class implements the ontology concept RangeActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class RangeActuator extends AbstractOntConcept implements IRangeActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "RangeActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#RangeActuator"; 
    ...
    */
 	...
 	*/
	public RangeActuator(String id) {
	...
	*/
 	...
 	*/
	public RangeActuator setDeviceID(String deviceID) {
 	...
 	*/
	public RangeActuator setVendor(String vendor) {
 	...
 	*/
	public RangeActuator setPhysicalLoc(IPhysicalLocation physicalLoc) {
