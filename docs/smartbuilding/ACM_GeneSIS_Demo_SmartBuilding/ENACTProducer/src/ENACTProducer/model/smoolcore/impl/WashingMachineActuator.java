...
import ENACTProducer.model.smoolcore.IWashingMachineActuator;
import ENACTProducer.model.smoolcore.IAlarm;
import ENACTProducer.model.smoolcore.impl.Alarm;
import ENACTProducer.model.smoolcore.IBooleanInformation;
import ENACTProducer.model.smoolcore.impl.BooleanInformation;
 ...
 * @version 1.0
 */
public class WashingMachineActuator extends AbstractOntConcept implements IWashingMachineActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "WashingMachineActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#WashingMachineActuator"; 
  		
  		
  	/**
    * The Constructor
    */
    public WashingMachineActuator() {
    	super();
        init();
	}
 	...
 	*/
	public WashingMachineActuator(String id) {
