...
import ENACTProducer.model.smoolcore.ILocation2D;
...
public class Location2D extends AbstractOntConcept implements ILocation2D, KPProducer, KPConsumer{
	...
	*/
 	...
 	*/
	public Location2D setDataID(String dataID) {
 	...
 	*/
	public Location2D setTimestamp(String timestamp) {
 	...
 	*/
	public Location2D setY(Double y) {
