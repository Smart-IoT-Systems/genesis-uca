...
import ENACTProducer.model.smoolcore.ISecurityConfidentiality;

/**
 * This class implements the ontology concept SecurityConfidentiality
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class SecurityConfidentiality extends AbstractOntConcept implements ISecurityConfidentiality, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "SecurityConfidentiality";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#SecurityConfidentiality"; 
  		
  		
  	/**
    * The Constructor
    */
    public SecurityConfidentiality() {
    	super();
        init();
	}
 	...
 	*/
	public SecurityConfidentiality(String id) {
	...
	*/
 	...
 	*/
	public SecurityConfidentiality setData(String data) {
 	...
 	*/
	public SecurityConfidentiality setDataID(String dataID) {
 	...
 	*/
	public SecurityConfidentiality setTimestamp(String timestamp) {
 	...
 	*/
	public SecurityConfidentiality setType(String type) {
