...
import ENACTProducer.model.smoolcore.ILocation;

/**
 * This class implements the ontology concept Location
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Location extends AbstractOntConcept implements ILocation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Location";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Location"; 
	...
	*/
 	...
 	*/
	public Location setDataID(String dataID) {
 	...
 	*/
	public Location setTimestamp(String timestamp) {
