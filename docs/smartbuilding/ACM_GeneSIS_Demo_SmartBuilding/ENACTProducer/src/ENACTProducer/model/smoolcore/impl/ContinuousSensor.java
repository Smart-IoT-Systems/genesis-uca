...
import ENACTProducer.model.smoolcore.IContinuousSensor;
...
/**
 * This class implements the ontology concept ContinuousSensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class ContinuousSensor extends AbstractOntConcept implements IContinuousSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "ContinuousSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#ContinuousSensor"; 
    ...
    */
 	...
 	*/
	public ContinuousSensor(String id) {
	...
	*/
 	...
 	*/
	public ContinuousSensor setDeviceID(String deviceID) {
 	...
 	*/
	public ContinuousSensor setVendor(String vendor) {
 	...
 	*/
	public ContinuousSensor setPhysicalLoc(IPhysicalLocation physicalLoc) {
