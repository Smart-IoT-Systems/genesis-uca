...
//		actuation = new CustomActuation(name);
		...
		SmoolKP.getProducer().createBlindPositionActuator(blindActuatorName, name, EnactConsumerMain.vendor, null, blindPos, null);
	...
	*/
    ...
    public void messageArrived(String s, MqttMessage mqttMessage) {
        ...
        if(s.equals("/home/A/Output/bool/Roller_Shades_1_(Down)")){
            ...
            try {
				SmoolKP.getProducer().updateBlindPositionActuator(blindActuatorName, name, EnactConsumerMain.vendor, null, blindPos, null);
