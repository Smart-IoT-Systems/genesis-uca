...
import ENACTConsumer.model.smoolcore.ISecurityAuthorization;

/**
 * This class implements the ontology concept SecurityAuthorization
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class SecurityAuthorization extends AbstractOntConcept implements ISecurityAuthorization, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "SecurityAuthorization";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#SecurityAuthorization"; 
    ...
    */
 	...
 	*/
	public SecurityAuthorization(String id) {
	...
	*/
 	...
 	*/
	public SecurityAuthorization setData(String data) {
 	...
 	*/
	public SecurityAuthorization setDataID(String dataID) {
 	...
 	*/
	public SecurityAuthorization setTimestamp(String timestamp) {
 	...
 	*/
	public SecurityAuthorization setType(String type) {
