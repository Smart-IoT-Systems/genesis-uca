...
import ENACTConsumer.model.smoolcore.ISecurityAuthentication;

/**
 * This class implements the ontology concept SecurityAuthentication
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class SecurityAuthentication extends AbstractOntConcept implements ISecurityAuthentication, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "SecurityAuthentication";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#SecurityAuthentication"; 
    ...
    */
 	...
 	*/
	public SecurityAuthentication(String id) {
	...
	*/
 	...
 	*/
	public SecurityAuthentication setData(String data) {
 	...
 	*/
	public SecurityAuthentication setDataID(String dataID) {
 	...
 	*/
	public SecurityAuthentication setTimestamp(String timestamp) {
 	...
 	*/
	public SecurityAuthentication setType(String type) {
