...
/**
 * This class implements the ontology concept FloodInformation
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class FloodInformation extends AbstractOntConcept implements IFloodInformation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "FloodInformation";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#FloodInformation"; 
    ...
    */
 	...
 	*/
	public FloodInformation(String id) {
	...
	*/
 	...
 	*/
	public FloodInformation setDataID(String dataID) {
 	...
 	*/
	public FloodInformation setStatus(Boolean status) {
 	...
 	*/
	public FloodInformation setTimestamp(String timestamp) {
 	...
 	*/
	public FloodInformation setSecurityData(ISecurity securityData) {
