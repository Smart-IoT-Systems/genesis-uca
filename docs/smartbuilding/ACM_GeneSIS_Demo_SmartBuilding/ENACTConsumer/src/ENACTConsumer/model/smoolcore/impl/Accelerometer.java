...
import ENACTConsumer.model.smoolcore.IAccelerometer;
import ENACTConsumer.model.smoolcore.IAccelerometerInformation;
import ENACTConsumer.model.smoolcore.impl.AccelerometerInformation;
...
/**
 * This class implements the ontology concept Accelerometer
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Accelerometer extends AbstractOntConcept implements IAccelerometer, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Accelerometer";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Accelerometer"; 
	...
	*/
 	...
 	*/
	public Accelerometer setDeviceID(String deviceID) {
 	...
 	*/
	public Accelerometer setVendor(String vendor) {
 	...
 	*/
	public Accelerometer setAccinfo(IAccelerometerInformation accinfo) {
 	...
 	*/
	public Accelerometer setPhysicalLoc(IPhysicalLocation physicalLoc) {
