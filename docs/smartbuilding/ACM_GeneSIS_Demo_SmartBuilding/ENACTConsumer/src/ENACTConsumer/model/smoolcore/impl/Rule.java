...
import ENACTConsumer.model.smoolcore.IRule;

/**
 * This class implements the ontology concept Rule
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Rule extends AbstractOntConcept implements IRule, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Rule";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Rule"; 
