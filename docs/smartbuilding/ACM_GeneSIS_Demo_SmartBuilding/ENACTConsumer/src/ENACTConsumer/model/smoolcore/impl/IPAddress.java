...
import ENACTConsumer.model.smoolcore.IIPAddress;
import ENACTConsumer.model.smoolcore.ILogicalLocation;
import ENACTConsumer.model.smoolcore.impl.LogicalLocation;

/**
 * This class implements the ontology concept IPAddress
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class IPAddress extends AbstractOntConcept implements IIPAddress, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "IPAddress";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#IPAddress"; 
	...
	*/
 	...
 	*/
	public IPAddress setDataID(String dataID) {
 	...
 	*/
	public IPAddress setTimestamp(String timestamp) {
 	...
 	*/
	public IPAddress setLogicalLoc(ILogicalLocation logicalLoc) {
