...
public class TwitterAccount extends AbstractOntConcept implements ITwitterAccount, KPProducer, KPConsumer{
	...
	*/
 	...
 	*/
	public TwitterAccount setDataID(String dataID) {
 	...
 	*/
	public TwitterAccount setPassword(String password) {
 	...
 	*/
	public TwitterAccount setTimestamp(String timestamp) {
 	...
 	*/
	public TwitterAccount setUsername(String username) {
 	...
 	*/
	public TwitterAccount setLogicalLoc(ILogicalLocation logicalLoc) {
