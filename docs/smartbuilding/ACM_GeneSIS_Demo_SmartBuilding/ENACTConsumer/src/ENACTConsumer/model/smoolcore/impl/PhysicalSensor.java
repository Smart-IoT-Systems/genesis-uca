...
import ENACTConsumer.model.smoolcore.IPhysicalSensor;
...
/**
 * This class implements the ontology concept PhysicalSensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class PhysicalSensor extends AbstractOntConcept implements IPhysicalSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "PhysicalSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#PhysicalSensor"; 
    ...
    */
 	...
 	*/
	public PhysicalSensor(String id) {
	...
	*/
 	...
 	*/
	public PhysicalSensor setDeviceID(String deviceID) {
 	...
 	*/
	public PhysicalSensor setVendor(String vendor) {
 	...
 	*/
	public PhysicalSensor setPhysicalLoc(IPhysicalLocation physicalLoc) {
