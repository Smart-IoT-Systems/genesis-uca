...
import ENACTConsumer.model.smoolcore.ITweetSendActuator;
...
import ENACTConsumer.model.smoolcore.impl.LogicalLocation;
import ENACTConsumer.model.smoolcore.IMessage;
import ENACTConsumer.model.smoolcore.impl.Message;
import ENACTConsumer.model.smoolcore.ITwitterAccount;
import ENACTConsumer.model.smoolcore.impl.TwitterAccount;

/**
 * This class implements the ontology concept TweetSendActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class TweetSendActuator extends AbstractOntConcept implements ITweetSendActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "TweetSendActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#TweetSendActuator"; 
  		
  		
  	/**
    * The Constructor
    */
    public TweetSendActuator() {
    	super();
        init();
	}
 	...
 	*/
	public TweetSendActuator(String id) {
	...
	public void init() {
      	...
      	// Creates the tweetWriter property
      	String tweetWriterIRI = "http://com.tecnalia.smool/core/smoolcore#tweetWriter";
      	String tweetWriterPrefix = "smoolcore";

      	FunctionalObjectSlot < TwitterAccount > tweetWriterSlot= new FunctionalObjectSlot<TwitterAccount>(TwitterAccount.class);
      	tweetWriterSlot._setIRI(tweetWriterIRI);
      	tweetWriterSlot._setPrefix(tweetWriterPrefix);
      	
      	this._addProperty(tweetWriterSlot);
	...
	*/
 	...
 	*/
	public TweetSendActuator setDeviceID(String deviceID) {
 	...
 	*/
	public TweetSendActuator setVendor(String vendor) {
 	...
 	*/
	public TweetSendActuator setLogicalLoc(ILogicalLocation logicalLoc) {
 	...
 	*/
	public TweetSendActuator setMessage(IMessage message) {
 	...
 	*/
	public TweetSendActuator setOrigin(ILogicalLocation origin) {
 	...
 	*/
	public TweetSendActuator setTweetWriter(ITwitterAccount tweetWriter) {
		this.updateAttribute("tweetWriter",tweetWriter);
		return this;        
	}
	...
	public ITwitterAccount getTweetWriter() {
    	return (ITwitterAccount) this._getFunctionalProperty("tweetWriter").getValue();
	}
