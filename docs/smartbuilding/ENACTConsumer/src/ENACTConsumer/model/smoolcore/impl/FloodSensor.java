...
import ENACTConsumer.model.smoolcore.IFloodSensor;
import ENACTConsumer.model.smoolcore.IAlarm;
import ENACTConsumer.model.smoolcore.impl.Alarm;
import ENACTConsumer.model.smoolcore.IFloodInformation;
import ENACTConsumer.model.smoolcore.impl.FloodInformation;
import ENACTConsumer.model.smoolcore.IPhysicalLocation;
import ENACTConsumer.model.smoolcore.impl.PhysicalLocation;

/**
 * This class implements the ontology concept FloodSensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class FloodSensor extends AbstractOntConcept implements IFloodSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "FloodSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#FloodSensor"; 
    ...
    */
	...
	public void init() {
      	...
      	// Creates the flood property
      	String floodIRI = "http://com.tecnalia.smool/core/smoolcore#flood";
      	String floodPrefix = "smoolcore";

      	FunctionalObjectSlot < FloodInformation > floodSlot= new FunctionalObjectSlot<FloodInformation>(FloodInformation.class);
      	floodSlot._setIRI(floodIRI);
      	floodSlot._setPrefix(floodPrefix);
      	
      	this._addProperty(floodSlot);
	...
	*/
 	...
 	*/
	public FloodSensor setDeviceID(String deviceID) {
 	...
 	*/
	public FloodSensor setVendor(String vendor) {
 	...
 	*/
	public FloodSensor setFlood(IFloodInformation flood) {
		this.updateAttribute("flood",flood);
		return this;        
	}
	...
	public IFloodInformation getFlood() {
    	return (IFloodInformation) this._getFunctionalProperty("flood").getValue();
	}
 	...
 	*/
	public FloodSensor setPhysicalLoc(IPhysicalLocation physicalLoc) {
