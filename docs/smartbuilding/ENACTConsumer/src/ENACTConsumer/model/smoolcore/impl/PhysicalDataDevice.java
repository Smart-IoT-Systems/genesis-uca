...
import ENACTConsumer.model.smoolcore.IPhysicalDataDevice;
...
public class PhysicalDataDevice extends AbstractOntConcept implements IPhysicalDataDevice, KPProducer, KPConsumer{
	...
	*/
 	...
 	*/
	public PhysicalDataDevice setDeviceID(String deviceID) {
 	...
 	*/
	public PhysicalDataDevice setVendor(String vendor) {
