...
import ENACTConsumer.model.smoolcore.IBlackoutSensor;
import ENACTConsumer.model.smoolcore.IAlarm;
import ENACTConsumer.model.smoolcore.impl.Alarm;
import ENACTConsumer.model.smoolcore.IBlackoutInformation;
import ENACTConsumer.model.smoolcore.impl.BlackoutInformation;
import ENACTConsumer.model.smoolcore.IPhysicalLocation;
import ENACTConsumer.model.smoolcore.impl.PhysicalLocation;

/**
 * This class implements the ontology concept BlackoutSensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class BlackoutSensor extends AbstractOntConcept implements IBlackoutSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "BlackoutSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#BlackoutSensor"; 
  		
  		
  	/**
    * The Constructor
    */
    public BlackoutSensor() {
    	super();
        init();
	}
 	...
 	*/
	public BlackoutSensor(String id) {
	...
	public void init() {
      	...
      	// Creates the blackout property
      	String blackoutIRI = "http://com.tecnalia.smool/core/smoolcore#blackout";
      	String blackoutPrefix = "smoolcore";

      	FunctionalObjectSlot < BlackoutInformation > blackoutSlot= new FunctionalObjectSlot<BlackoutInformation>(BlackoutInformation.class);
      	blackoutSlot._setIRI(blackoutIRI);
      	blackoutSlot._setPrefix(blackoutPrefix);
      	
      	this._addProperty(blackoutSlot);
	...
	*/
 	...
 	*/
	public BlackoutSensor setDeviceID(String deviceID) {
 	...
 	*/
	public BlackoutSensor setVendor(String vendor) {
	...
	public void removeAlarms(IAlarm alarms) {
 	...
 	/**
 	* Sets the blackout property.
 	* @param blackout IBlackoutInformation value
 	*/
	public BlackoutSensor setBlackout(IBlackoutInformation blackout) {
		this.updateAttribute("blackout",blackout);
		return this;        
	}
		
	 /**
 	* Gets the blackout property.
 	* @return a IBlackoutInformation value
 	*/
	public IBlackoutInformation getBlackout() {
    	return (IBlackoutInformation) this._getFunctionalProperty("blackout").getValue();
	}
 	...
 	*/
	public BlackoutSensor setPhysicalLoc(IPhysicalLocation physicalLoc) {
