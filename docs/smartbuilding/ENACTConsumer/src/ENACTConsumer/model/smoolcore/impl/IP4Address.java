...
import ENACTConsumer.model.smoolcore.IIP4Address;
import ENACTConsumer.model.smoolcore.ILogicalLocation;
import ENACTConsumer.model.smoolcore.impl.LogicalLocation;

/**
 * This class implements the ontology concept IP4Address
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class IP4Address extends AbstractOntConcept implements IIP4Address, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "IP4Address";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#IP4Address"; 
	...
	*/
 	...
 	*/
	public IP4Address setDataID(String dataID) {
 	...
 	*/
	public IP4Address setTimestamp(String timestamp) {
 	...
 	*/
	public IP4Address setLogicalLoc(ILogicalLocation logicalLoc) {
