...
import ENACTConsumer.model.smoolcore.IHumiditySensor;
import ENACTConsumer.model.smoolcore.IAlarm;
import ENACTConsumer.model.smoolcore.impl.Alarm;
import ENACTConsumer.model.smoolcore.IHumidityInformation;
import ENACTConsumer.model.smoolcore.impl.HumidityInformation;
import ENACTConsumer.model.smoolcore.IPhysicalLocation;
import ENACTConsumer.model.smoolcore.impl.PhysicalLocation;

/**
 * This class implements the ontology concept HumiditySensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class HumiditySensor extends AbstractOntConcept implements IHumiditySensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "HumiditySensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#HumiditySensor"; 
    ...
    */
	...
	public void init() {
      	...
      	// Creates the humidity property
      	String humidityIRI = "http://com.tecnalia.smool/core/smoolcore#humidity";
      	String humidityPrefix = "smoolcore";

      	FunctionalObjectSlot < HumidityInformation > humiditySlot= new FunctionalObjectSlot<HumidityInformation>(HumidityInformation.class);
      	humiditySlot._setIRI(humidityIRI);
      	humiditySlot._setPrefix(humidityPrefix);
      	
      	this._addProperty(humiditySlot);
	...
	*/
 	...
 	*/
	public HumiditySensor setDeviceID(String deviceID) {
 	...
 	*/
	public HumiditySensor setVendor(String vendor) {
 	...
 	*/
	public HumiditySensor setHumidity(IHumidityInformation humidity) {
		this.updateAttribute("humidity",humidity);
		return this;        
	}
	...
	public IHumidityInformation getHumidity() {
    	return (IHumidityInformation) this._getFunctionalProperty("humidity").getValue();
	}
 	...
 	*/
	public HumiditySensor setPhysicalLoc(IPhysicalLocation physicalLoc) {
