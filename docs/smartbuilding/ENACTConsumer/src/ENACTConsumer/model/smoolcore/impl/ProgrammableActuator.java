...
import ENACTConsumer.model.smoolcore.IProgrammableActuator;
...
import ENACTConsumer.model.smoolcore.impl.ProgrammeInformation;

/**
 * This class implements the ontology concept ProgrammableActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class ProgrammableActuator extends AbstractOntConcept implements IProgrammableActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "ProgrammableActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#ProgrammableActuator"; 
  		
  		
  	/**
    * The Constructor
    */
    public ProgrammableActuator() {
    	super();
        init();
	}
 	...
 	*/
	public ProgrammableActuator(String id) {
	...
	public void init() {
      	...
      	// Creates the programme property
      	String programmeIRI = "http://com.tecnalia.smool/core/smoolcore#programme";
      	String programmePrefix = "smoolcore";

      	FunctionalObjectSlot < ProgrammeInformation > programmeSlot= new FunctionalObjectSlot<ProgrammeInformation>(ProgrammeInformation.class);
      	programmeSlot._setIRI(programmeIRI);
      	programmeSlot._setPrefix(programmePrefix);
	...
	*/
 	...
 	*/
	public ProgrammableActuator setDeviceID(String deviceID) {
 	...
 	*/
	public ProgrammableActuator setVendor(String vendor) {
 	...
 	*/
	public ProgrammableActuator setPhysicalLoc(IPhysicalLocation physicalLoc) {
 	...
 	*/
	public ProgrammableActuator setProgramme(IProgrammeInformation programme) {
