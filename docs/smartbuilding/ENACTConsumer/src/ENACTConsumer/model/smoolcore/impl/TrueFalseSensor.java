...
import ENACTConsumer.model.smoolcore.ITrueFalseSensor;
 ...
 * @version 1.0
 */
public class TrueFalseSensor extends AbstractOntConcept implements ITrueFalseSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "TrueFalseSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#TrueFalseSensor"; 
  		
  		
  	/**
    * The Constructor
    */
    public TrueFalseSensor() {
    	super();
        init();
	}
 	...
 	*/
	public TrueFalseSensor(String id) {
