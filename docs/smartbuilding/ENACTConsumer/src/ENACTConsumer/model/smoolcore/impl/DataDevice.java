...
import ENACTConsumer.model.smoolcore.IDataDevice;
import ENACTConsumer.model.smoolcore.IAlarm;
import ENACTConsumer.model.smoolcore.impl.Alarm;

/**
 * This class implements the ontology concept DataDevice
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class DataDevice extends AbstractOntConcept implements IDataDevice, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "DataDevice";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#DataDevice"; 
	...
	*/
 	...
 	*/
	public DataDevice setDeviceID(String deviceID) {
 	...
 	*/
	public DataDevice setVendor(String vendor) {
