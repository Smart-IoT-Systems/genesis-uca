...
/**
 * This class implements the ontology concept PhysicalLocation
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class PhysicalLocation extends AbstractOntConcept implements IPhysicalLocation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "PhysicalLocation";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#PhysicalLocation"; 
    ...
    */
 	...
 	*/
	public PhysicalLocation(String id) {
	...
	*/
 	...
 	*/
	public PhysicalLocation setDataID(String dataID) {
 	...
 	*/
	public PhysicalLocation setTimestamp(String timestamp) {
