...
import ENACTConsumer.model.smoolcore.ISecurityIntegrity;

/**
 * This class implements the ontology concept SecurityIntegrity
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class SecurityIntegrity extends AbstractOntConcept implements ISecurityIntegrity, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "SecurityIntegrity";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#SecurityIntegrity"; 
  		
  		
  	/**
    * The Constructor
    */
    public SecurityIntegrity() {
    	super();
        init();
	}
 	...
 	*/
	public SecurityIntegrity(String id) {
	...
	*/
 	...
 	*/
	public SecurityIntegrity setData(String data) {
 	...
 	*/
	public SecurityIntegrity setDataID(String dataID) {
 	...
 	*/
	public SecurityIntegrity setTimestamp(String timestamp) {
 	...
 	*/
	public SecurityIntegrity setType(String type) {
