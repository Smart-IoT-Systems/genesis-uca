...
/**
 * This class implements the ontology concept LogicalLocation
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class LogicalLocation extends AbstractOntConcept implements ILogicalLocation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "LogicalLocation";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#LogicalLocation"; 
	...
	*/
 	...
 	*/
	public LogicalLocation setDataID(String dataID) {
 	...
 	*/
	public LogicalLocation setTimestamp(String timestamp) {
 	...
 	*/
	public LogicalLocation setLogicalLoc(ILogicalLocation logicalLoc) {
