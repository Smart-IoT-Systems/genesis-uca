...
import ENACTConsumer.model.smoolcore.ILogicalSensor;
 ...
 * @version 1.0
 */
public class LogicalSensor extends AbstractOntConcept implements ILogicalSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "LogicalSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#LogicalSensor"; 
    ...
    */
 	...
 	*/
	public LogicalSensor(String id) {
