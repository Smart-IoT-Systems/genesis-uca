...
import ENACTConsumer.model.smoolcore.IFacebookAccount;
import ENACTConsumer.model.smoolcore.ILogicalLocation;
import ENACTConsumer.model.smoolcore.impl.LogicalLocation;

/**
 * This class implements the ontology concept FacebookAccount
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class FacebookAccount extends AbstractOntConcept implements IFacebookAccount, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "FacebookAccount";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#FacebookAccount"; 
