...
/**
 * This class implements the ontology concept BlackoutInformation
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class BlackoutInformation extends AbstractOntConcept implements IBlackoutInformation, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "BlackoutInformation";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#BlackoutInformation"; 
  		
  		
  	/**
    * The Constructor
    */
    public BlackoutInformation() {
    	super();
        init();
	}
 	...
 	*/
	public BlackoutInformation(String id) {
	...
	*/
 	...
 	*/
	public BlackoutInformation setDataID(String dataID) {
 	...
 	*/
	public BlackoutInformation setStatus(Boolean status) {
 	...
 	*/
	public BlackoutInformation setTimestamp(String timestamp) {
 	...
 	*/
	public BlackoutInformation setSecurityData(ISecurity securityData) {
