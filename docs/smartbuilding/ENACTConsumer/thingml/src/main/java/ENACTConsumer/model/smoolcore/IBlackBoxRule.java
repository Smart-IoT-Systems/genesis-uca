...
/**
 * This class implements interface for the ontology concept BlackBoxRule
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */

public interface IBlackBoxRule extends IAbstractOntConcept, IRule{
   ...
   /*
 	...
 	*/
 	public IBlackBoxRule setRuleID(String ruleID );
