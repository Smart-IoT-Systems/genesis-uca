...
import ENACTConsumer.model.smoolcore.IMessageReceiveSensor;
 ...
 * @version 1.0
 */
public class MessageReceiveSensor extends AbstractOntConcept implements IMessageReceiveSensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "MessageReceiveSensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#MessageReceiveSensor"; 
  		
  		
  	/**
    * The Constructor
    */
    public MessageReceiveSensor() {
    	super();
        init();
	}
 	...
 	*/
	public MessageReceiveSensor(String id) {
