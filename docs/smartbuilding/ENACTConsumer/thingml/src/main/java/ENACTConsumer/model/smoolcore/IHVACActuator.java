...
/**
 * This class implements interface for the ontology concept HVACActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */

public interface IHVACActuator extends IAbstractOntConcept, IProgrammableActuator, IRangeActuator{
