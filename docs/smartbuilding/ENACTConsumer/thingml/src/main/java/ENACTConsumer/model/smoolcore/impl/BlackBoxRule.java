...
import ENACTConsumer.model.smoolcore.IBlackBoxRule;

/**
 * This class implements the ontology concept BlackBoxRule
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class BlackBoxRule extends AbstractOntConcept implements IBlackBoxRule, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "BlackBoxRule";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#BlackBoxRule"; 
	...
	*/
 	...
 	*/
	public BlackBoxRule setRuleID(String ruleID) {
