...
import ENACTConsumer.model.smoolcore.ICompoundDevice;
import ENACTConsumer.model.smoolcore.IAlarm;
import ENACTConsumer.model.smoolcore.impl.Alarm;
import ENACTConsumer.model.smoolcore.ISimpleDevice;
import ENACTConsumer.model.smoolcore.impl.SimpleDevice;

/**
 * This class implements the ontology concept CompoundDevice
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class CompoundDevice extends AbstractOntConcept implements ICompoundDevice, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "CompoundDevice";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#CompoundDevice"; 
    ...
    */
 	...
 	*/
	public CompoundDevice(String id) {
	...
	public void init() {
      	...
      	// Creates the composedOf property
      	String composedOfIRI = "http://com.tecnalia.smool/core/smoolcore#composedOf";
      	String composedOfPrefix = "smoolcore";

      	NonFunctionalObjectSlot < SimpleDevice > composedOfSlot= new NonFunctionalObjectSlot<SimpleDevice>(SimpleDevice.class);
      	composedOfSlot._setIRI(composedOfIRI);
      	composedOfSlot._setPrefix(composedOfPrefix);
      	
      	this._addProperty(composedOfSlot);
	...
	*/
 	...
 	*/
	public CompoundDevice setDeviceID(String deviceID) {
 	...
 	*/
	public CompoundDevice setVendor(String vendor) {
	...
	public void addComposedOf(ISimpleDevice composedOf) {
	  ...
	  if (!this.containsAttribute("composedOf",composedOf)) {
            this.addAttribute("composedOf",composedOf);
        }
	...
	public void removeComposedOf(ISimpleDevice composedOf) {
	  if (this.containsAttribute("composedOf",composedOf)) {
            this.removeAttribute("composedOf",composedOf);
        }
