...
import ENACTProducer.model.smoolcore.INotification;

/**
 * This class implements the ontology concept Notification
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Notification extends AbstractOntConcept implements INotification, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Notification";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Notification"; 
	...
	*/
 	...
 	*/
	public Notification setDataID(String dataID) {
 	...
 	*/
	public Notification setTimestamp(String timestamp) {
