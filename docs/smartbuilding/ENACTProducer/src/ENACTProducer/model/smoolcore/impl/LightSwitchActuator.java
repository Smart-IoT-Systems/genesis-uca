...
import ENACTProducer.model.smoolcore.ILightSwitchActuator;
...
/**
 * This class implements the ontology concept LightSwitchActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class LightSwitchActuator extends AbstractOntConcept implements ILightSwitchActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "LightSwitchActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#LightSwitchActuator"; 
  		
  		
  	/**
    * The Constructor
    */
    public LightSwitchActuator() {
    	super();
        init();
	}
 	...
 	*/
	public LightSwitchActuator(String id) {
	...
	*/
 	...
 	*/
	public LightSwitchActuator setDeviceID(String deviceID) {
 	...
 	*/
	public LightSwitchActuator setVendor(String vendor) {
 	...
 	*/
	public LightSwitchActuator setBool(IBooleanInformation bool) {
 	...
 	*/
	public LightSwitchActuator setPhysicalLoc(IPhysicalLocation physicalLoc) {
