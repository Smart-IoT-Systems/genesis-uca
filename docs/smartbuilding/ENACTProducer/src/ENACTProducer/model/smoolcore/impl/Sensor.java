...
import ENACTProducer.model.smoolcore.ISensor;
import ENACTProducer.model.smoolcore.IAlarm;
import ENACTProducer.model.smoolcore.impl.Alarm;

/**
 * This class implements the ontology concept Sensor
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class Sensor extends AbstractOntConcept implements ISensor, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "Sensor";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#Sensor"; 
	...
	*/
 	...
 	*/
	public Sensor setDeviceID(String deviceID) {
 	...
 	*/
	public Sensor setVendor(String vendor) {
