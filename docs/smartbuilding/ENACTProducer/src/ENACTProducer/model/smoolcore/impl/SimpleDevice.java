...
/**
 * This class implements the ontology concept SimpleDevice
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class SimpleDevice extends AbstractOntConcept implements ISimpleDevice, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "SimpleDevice";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#SimpleDevice"; 
	...
	*/
 	...
 	*/
	public SimpleDevice setDeviceID(String deviceID) {
 	...
 	*/
	public SimpleDevice setVendor(String vendor) {
