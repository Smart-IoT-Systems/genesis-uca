...
import ENACTProducer.model.smoolcore.ILightRangeActuator;
...
/**
 * This class implements the ontology concept LightRangeActuator
 * including all its properties.
 * @author Genrated via EMF OWL to java transformation
 * @version 1.0
 */
public class LightRangeActuator extends AbstractOntConcept implements ILightRangeActuator, KPProducer, KPConsumer{

    //Not needed.. public static String CLASS_NAMESPACE = "http://com.tecnalia.smool/core/smoolcore#";
  	//Not needed.. public static String CLASS_ID = "LightRangeActuator";
  	public static String CLASS_IRI = "http://com.tecnalia.smool/core/smoolcore#LightRangeActuator"; 
  		
  		
  	/**
    * The Constructor
    */
    public LightRangeActuator() {
    	super();
        init();
	}
 	...
 	*/
	public LightRangeActuator(String id) {
	...
	public void init() {
      	...
      	// Creates the lightIntensity property
      	String lightIntensityIRI = "http://com.tecnalia.smool/core/smoolcore#lightIntensity";
      	String lightIntensityPrefix = "smoolcore";

      	FunctionalObjectSlot < ContinuousInformation > lightIntensitySlot= new FunctionalObjectSlot<ContinuousInformation>(ContinuousInformation.class);
      	lightIntensitySlot._setIRI(lightIntensityIRI);
      	lightIntensitySlot._setPrefix(lightIntensityPrefix);
      	
      	this._addProperty(lightIntensitySlot);
	...
	*/
 	...
 	*/
	public LightRangeActuator setDeviceID(String deviceID) {
 	...
 	*/
	public LightRangeActuator setVendor(String vendor) {
	...
	public void removeAlarms(IAlarm alarms) {
 	...
 	/**
 	* Sets the lightIntensity property.
 	* @param lightIntensity IContinuousInformation value
 	*/
	public LightRangeActuator setLightIntensity(IContinuousInformation lightIntensity) {
		this.updateAttribute("lightIntensity",lightIntensity);
		return this;        
	}
		
	 /**
 	* Gets the lightIntensity property.
 	* @return a IContinuousInformation value
 	*/
	public IContinuousInformation getLightIntensity() {
    	return (IContinuousInformation) this._getFunctionalProperty("lightIntensity").getValue();
	}
 	...
 	*/
	public LightRangeActuator setPhysicalLoc(IPhysicalLocation physicalLoc) {
